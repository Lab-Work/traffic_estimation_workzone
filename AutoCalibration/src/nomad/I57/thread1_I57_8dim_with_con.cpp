...
int main ( int argc , char ** argv ) {
  ...
  string para_file ("C:\\thread1_sim_com\\sim_paras.txt");
  string val_file ("C:\\thread1_sim_com\\sim_val.txt");
    ...
    else 
    {
      ...
      if (c1 <= 0 && c2 <= 0)
      {
        ...
        if (parasfile.is_open()){
          ...
          parasfile << "car_minHeadway," << ((x[6]-1)*0.5+1) << ",0," << ((x[6]-1)*0.5+1) << "," << ((x[6]-1)*0.5+1) << '\n';
          parasfile << "truck_minHeadway," << ((x[7]-1)*0.5+1) << ",0," << ((x[7]-1)*0.5+1) << "," << ((x[7]-1)*0.5+1) << '\n';
        }
        else
          perror("unable to open C:\\thread1_sim_com\\sim_paras.txt file\n");
