...
opt_step_file = 'C:/Users/TrafficControl/Dropbox/DesktopServer/Workzone_autocalibration' + \
              '/I57_SB/Logs/thread2_previous_opt_log.csv'
    ...
    if (len(argv) < 2):
        ...
        if console.open(argv[1]):
            ...
            if simulate_default is True:
                ...
                # test
                console.save("thread2_calib_I57_SB_default.ang")
                print_cmd('\nthread2_calib_I57_SB_default.ang saved.')
            ...
            if simulate_user is True:
                ...
                # test
                console.save("thread2_calib_I57_SB_user.ang")
                print_cmd('\nthread2_calib_I57_SB_user.ang saved.')
            ...
            if solved_flag is True:
                ...
                # save the ang file
                console.save("thread2_calib_I57_SB_optimal.ang")
                print_cmd('\nthread2_calib_I57_SB_optimal.ang saved.')
